...
urlpatterns = [
    ...
    path('tipoCliente_delete/<idTipoCliente>/', tipoCliente_delete, name="tipoCliente_delete"),
    path('tipoCliente_edit/<idTipoCliente>/', tipoCliente_edit, name='tipoCliente_edit'),
